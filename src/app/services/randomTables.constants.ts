...
export const SKILLS = [
  {percent: '10%', cost: 1, pre: [], descrip: 'Archaelogy: Ancient cultures and their artifacts'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Art: The expression or application of a species’ creative ability and imagination'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Athletics: Physical sports and games'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Biology: Study of life'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Chemistry: The identification of the substances of which matter is composed'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Computers: Fluent use of computers and networks'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Driving: Operation and control of motor vehicles'},
  {percent: '10%', cost: 1, pre: [], descrip: 'First Aid: Emergency medical care and treatment'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Geology: The solid features of any terrestrial planet or natural satellite'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Heavy Machinery: Operation and use of large pieces of equipment (cranes, exosuits, forklifts, etc.)'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Hydroponics: Growing plants in nutrient solutions without soil (farming in space)'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Linguistics: Study of language'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Mathematics: The science of numbers, quantity, and space.'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Mechanical Repair: Fixing broken machines'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Military Training: Standard basic training given to all military personnel'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Piloting: Operation and control of air and spacecraft'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Rimwise: Outer rim colonies and seedy parts of the galaxy'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Scavenging: Searching discarded waste for useful items'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Theology: Study of religion'},
  {percent: '10%', cost: 1, pre: [], descrip: 'Zero-G: Working in a vaccuum, vaccsuits, etc'},
  {percent: '15%', cost: 2, pre: ['geology', 'zero-g', 'scavenging', 'heavy machinery'], descrip: 'Asteroid Mining: Training in the tools and procedures used in mining asteroids'},
  {percent: '15%', cost: 2, pre: ['pioloting'] , descrip: 'Astrogation: Navigation in outer space'},
  {percent: '15%', cost: 2, pre: ['hydroponics'] , descrip: 'Botany: The study of plant life'},
  {percent: '15%', cost: 2, pre: ['military training', 'rimwise', 'athletics'], descrip: 'Close-Quarters Combat: Hand-to-hand, melee fighting'},
  {percent: '15%', cost: 2, pre: ['heavy machinery', 'mechanical repair', 'computers'], descrip: 'Engineering: design, building, and use of engines, machines, and structures'},
  {percent: '15%', cost: 2, pre: ['military training', 'chemistry'] , descrip: 'Explosives: Bombs and incendiary devices'},
  {percent: '15%', cost: 2, pre: ['military training', 'rimwise'] , descrip: 'Firearms: Guns and their use'},
  {percent: '15%', cost: 2, pre: ['biology'] , descrip: 'Genetics: Heredity and the variation of inherited characteristics'},
  {percent: '15%', cost: 2, pre: ['military training'] , descrip: 'Gunnery: Starship weaponry'},
  {percent: '15%', cost: 2, pre: ['computers'] , descrip: 'Hacking: Unauthorized access to computer systems'},
  {percent: '15%', cost: 2, pre: ['scavenging', 'computers'] , descrip: 'Jury-Rigging: Makeshift repairs'},
  {percent: '15%', cost: 2, pre: ['art', 'archaeology', 'theology'] , descrip: 'Mysticism: Spiritual apprehension of hidden knowledge'},
  {percent: '15%', cost: 2, pre: ['first aid'] , descrip: 'Pathology: Study of the cause and effect of disease'},
  {percent: '15%', cost: 2, pre: ['mathematics'] , descrip: 'Physics: Study of nature and properties of matter and energy'},
  {percent: '15%', cost: 2, pre: ['geology'] , descrip: 'Planetology: Study of planets and other celestial bodies'},
  {percent: '15%', cost: 2, pre: ['biology'] , descrip: 'Psychology: The study of behavior and the human mind'},
  {percent: '15%', cost: 2, pre: ['military training'] , descrip: 'Tactics: Manuevering millitary forces in battle'},
  {percent: '15%', cost: 2, pre: ['mechanical repair', 'driving', 'piloting'] , descrip: 'Vehicle Specialization: Specific vehicle classes'},
  {percent: '20%', cost: 3, pre: ['engineering', 'hacking'] , descrip: 'Artificial Intelligence: Knowledge of simulacrum of human consciousness'},
  {percent: '20%', cost: 3, pre: ['vehicle specialization', 'tactics'] , descrip: 'Command: Leadership and authority'},
  {percent: '20%', cost: 3, pre: ['jury rigging', 'engineering'] , descrip: 'Cybernetics: Interface between man and machine'},
  {percent: '20%', cost: 3, pre: ['astrogation', 'physics', 'mysticism'] , descrip: 'Hyperspace: Faster-than-light travel'},
  {percent: '20%', cost: 3, pre: ['engineering'] , descrip: 'Robotics: Design and operation of robots, drones, and androids'},
  {percent: '20%', cost: 3, pre: ['linguistics'] , descrip: 'Sophontology: Alien psychology'},
  {percent: '20%', cost: 3, pre: ['gunnery', 'firearms', 'close-quarters combat', 'explosives'], descrip: 'Weapon Specialization: Proficiency with a specific weapon'},
  {percent: '20%', cost: 3, pre: ['genetics', 'botany', 'pathology'] , descrip: 'Xenobiology: Alien biology'},
  {percent: '20%', cost: 3, pre: ['mysticism'] , descrip: 'Xenoesotericism: Obscure alien mysticism, religion, and belief'},
  {percent: '20%', cost: 3, pre: ['pathology'], descrip: 'Surgery: Medical speciality involving manual operation'}
];
